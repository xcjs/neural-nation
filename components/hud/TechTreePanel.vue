<template>
  <div class="border border-cyan-900/50 bg-black/70 backdrop-blur-sm p-3">
    <h3 class="text-cyan-400 text-xs font-bold tracking-wider mb-2">TECH TREE</h3>
    <div class="space-y-0.5 max-h-64 overflow-y-auto">
      ...
      <div v-if="techtree.nodes.length === 0" class="text-cyan-700 text-xs">No tech data.</div>
    </div>
  </div>
</template>
