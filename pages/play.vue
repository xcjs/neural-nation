  ...
  <div class="relative w-screen h-screen overflow-hidden bg-black">
    ...
    >
      ...
      <div class="text-cyan-600 text-xs space-y-1 mb-6">
        ...
        <p>Final population: {{ environment.state.pollutionLevel.toFixed(0) }} pollution</p>
      </div>
    ...
    <div class="absolute inset-0 z-10 pointer-events-none">
      ...
      <div class="absolute top-0 left-0 right-0 pointer-events-auto bg-black/80 border-b border-cyan-900/50 backdrop-blur-sm">
        <div class="flex items-center justify-between px-4 py-2">
          <div class="flex items-center gap-4">
            ...
            <span v-if="ui.spectatorMode" class="text-yellow-500 text-xs border border-yellow-800 px-2 py-0.5">SPECTATING</span>
          </div>
      ...
      <div class="absolute top-12 right-0 bottom-0 w-80 pointer-events-auto overflow-y-auto p-2 space-y-2">
        ...
        <TokenManagement v-if="ui.panelVisibility.tokenManagement && !ui.spectatorMode" />
      </div>
