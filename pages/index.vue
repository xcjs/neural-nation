<template>
  <div class="min-h-screen bg-black text-cyan-100 font-mono flex flex-col items-center justify-center p-8">
    <div class="max-w-2xl w-full">
      <h1 class="text-4xl font-bold text-cyan-400 mb-2 tracking-wider">NEURAL NATION</h1>
      <p class="text-cyan-600 mb-8 text-sm">Watch an LLM autonomously build an industrial economy on a 3D Earth.</p>
      ...
      <div class="mb-6">
        ...
        <p class="text-cyan-700 text-xs mt-1">{{ difficultyDescription }}</p>
      </div>
      ...
      <div v-if="created" class="mt-8 border border-cyan-900 p-4 bg-cyan-950 bg-opacity-30">
        <p class="text-cyan-500 text-sm mb-2">MCP CONNECTION URL</p>
